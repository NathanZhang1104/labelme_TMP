...
class Canvas(QtWidgets.QWidget):
    ...
    rectangle_sig=QtCore.Signal(list)
    CREATE, EDIT = 0, 1
                ...
                if self.current:#shape_list
                    ...
                    if self.createMode == "polygon":
                        ...
                        if(self.createMode=="rectangle"):
                            self.rectangle_sig.emit(self.current.points)
    ...
    def mouseReleaseEvent(self, ev):
        ...
        if self.movingShape and self.hShape:
            ...
            print(index)
            print(len(self.shapesBackups[-1]))
    ...
    def finalise(self,hullshape=None):
        assert self.current
        self.current.close()
